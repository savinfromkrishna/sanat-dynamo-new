...
export function IllustEcommerce({ className = "" }: { className?: string }) {
  return (
    <motion.svg viewBox="0 0 160 110" fill="none" className={className} initial="hidden" whileInView="visible" viewport={{ once: true }}>
      ...
      <motion.circle cx="42" cy="66" r="3" fill="none" stroke="oklch(0.78 0.165 70 / 0.45)" strokeWidth="0.8" variants={pop(1)} />
      <motion.circle cx="66" cy="66" r="3" fill="none" stroke="oklch(0.78 0.165 70 / 0.45)" strokeWidth="0.8" variants={pop(1)} />
      {/* Arrow to conversion */}
      <motion.path d="M 75 50 L 95 50" stroke="oklch(0.78 0.165 70 / 0.4)" strokeWidth="0.8" strokeDasharray="2 2" variants={draw(2)} />
      {/* Conversion box */}
      <motion.rect x="95" y="38" width="50" height="24" rx="5" fill="oklch(0.74 0.16 155 / 0.05)" stroke="oklch(0.74 0.16 155 / 0.5)" strokeWidth="0.8" variants={draw(2)} />
      ...
      <motion.text x="120" y="58" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="5" fill="oklch(0.74 0.16 155 / 0.5)" variants={pop(3)}>CVR</motion.text>
      {/* Cart recovery loop (the WhatsApp recovery) */}
      <motion.path d="M 50 60 C 50 80, 80 85, 95 75 C 105 68, 110 62, 110 55" stroke="oklch(0.66 0.18 295 / 0.4)" strokeWidth="0.8" strokeDasharray="3 3" fill="none" variants={draw(3)} />
      ...
      <motion.g variants={pop(5)}>
        ...
        <text x="120" y="104" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="5" fill="oklch(0.78 0.165 70 / 0.5)">PURCHASE RATE</text>
      </motion.g>
    </motion.svg>
  );
}
...
export function IllustRealEstate({ className = "" }: { className?: string }) {
  return (
    <motion.svg viewBox="0 0 160 110" fill="none" className={className} initial="hidden" whileInView="visible" viewport={{ once: true }}>
      {/* Building silhouette */}
      <motion.rect x="15" y="20" width="35" height="60" rx="3" stroke="oklch(0.78 0.165 70 / 0.45)" strokeWidth="0.8" fill="none" variants={draw(0)} />
      {/* Windows */}
      {[28, 42, 56, 68].map((y) =>
        [22, 34].map((x) => (
          <motion.rect key={`${x}-${y}`} x={x} y={y} width="6" height="5" rx="1" fill="oklch(0.78 0.165 70 / 0.06)" stroke="oklch(0.78 0.165 70 / 0.22)" strokeWidth="0.4" variants={pop(1)} />
        ))
      )}
      {/* Lead funnel — from portal leads to qualified */}
      <motion.path d="M 58 40 L 75 35 L 95 35 L 85 55 L 75 55 Z" stroke="oklch(0.66 0.18 295 / 0.45)" strokeWidth="0.8" fill="oklch(0.66 0.18 295 / 0.03)" variants={draw(2)} />
      ...
      {/* Arrow to result */}
      <motion.path d="M 90 50 L 105 50" stroke="oklch(0.74 0.16 155 / 0.4)" strokeWidth="0.8" variants={draw(3)} />
      {/* Result metrics */}
      <motion.g variants={pop(4)}>
        <rect x="105" y="30" width="45" height="40" rx="5" fill="oklch(0.74 0.16 155 / 0.04)" stroke="oklch(0.74 0.16 155 / 0.4)" strokeWidth="0.6" />
        ...
        <text x="128" y="55" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="5" fill="oklch(0.74 0.16 155 / 0.5)">INBOUND</text>
        <text x="128" y="62" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="5" fill="oklch(0.74 0.16 155 / 0.5)">LEADS</text>
      </motion.g>
      {/* CPL reduction */}
      <motion.g variants={pop(5)}>
  ...
  return (
    <motion.svg viewBox="0 0 160 110" fill="none" className={className} initial="hidden" whileInView="visible" viewport={{ once: true }}>
      ...
      <motion.g variants={pop(0)}>
        <rect x="20" y="25" width="25" height="25" rx="5" fill="var(--svg-node-fill)" stroke="oklch(0.74 0.16 155 / 0.5)" strokeWidth="0.8" />
      ...
      <motion.rect x="55" y="18" width="30" height="50" rx="5" stroke="oklch(0.78 0.165 70 / 0.45)" strokeWidth="0.8" fill="none" variants={draw(1)} />
      <motion.rect x="62" y="28" width="16" height="6" rx="2" fill="oklch(0.78 0.165 70 / 0.35)" stroke="oklch(0.78 0.165 70 / 0.35)" strokeWidth="0.4" variants={pop(2)} />
      <motion.rect x="62" y="38" width="16" height="6" rx="2" fill="oklch(0.74 0.16 155 / 0.35)" stroke="oklch(0.74 0.16 155 / 0.35)" strokeWidth="0.4" variants={pop(2)} />
      <motion.rect x="62" y="48" width="16" height="6" rx="2" fill="oklch(0.78 0.165 70 / 0.22)" stroke="oklch(0.78 0.165 70 / 0.45)" strokeWidth="0.4" variants={pop(3)} />
      ...
      {/* Arrow: auto */}
      <motion.path d="M 48 37 L 55 37" stroke="oklch(0.66 0.18 295 / 0.4)" strokeWidth="0.6" strokeDasharray="2 2" variants={draw(2)} />
      <motion.text x="50" y="33" fontFamily="var(--font-mono)" fontSize="4" fill="oklch(0.66 0.18 295 / 0.35)" variants={pop(3)}>AUTO</motion.text>
      {/* Results */}
      <motion.g variants={pop(4)}>
        <rect x="95" y="22" width="50" height="22" rx="5" fill="oklch(0.74 0.16 155 / 0.04)" stroke="oklch(0.74 0.16 155 / 0.4)" strokeWidth="0.6" />
        ...
        <text x="120" y="41" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="5" fill="oklch(0.74 0.16 155 / 0.5)">AUTO-BOOKED</text>
      </motion.g>
      <motion.g variants={pop(5)}>
        <rect x="95" y="50" width="50" height="22" rx="5" fill="oklch(0.78 0.165 70 / 0.04)" stroke="oklch(0.78 0.165 70 / 0.4)" strokeWidth="0.6" />
        ...
        <text x="120" y="69" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="5" fill="oklch(0.78 0.165 70 / 0.5)">REMINDERS</text>
      </motion.g>
      {/* Google Maps pin */}
...
export function IllustEdtech({ className = "" }: { className?: string }) {
  return (
    <motion.svg viewBox="0 0 160 110" fill="none" className={className} initial="hidden" whileInView="visible" viewport={{ once: true }}>
      {/* Graduation cap */}
      <motion.g variants={pop(0)}>
        <path d="M 30 35 L 15 42 L 30 49 L 45 42 Z" fill="oklch(0.66 0.18 295 / 0.4)" stroke="oklch(0.66 0.18 295 / 0.5)" strokeWidth="0.8" />
        <line x1="30" y1="49" x2="30" y2="60" stroke="oklch(0.66 0.18 295 / 0.4)" strokeWidth="0.6" />
        <path d="M 22 50 L 22 58 C 22 62, 30 65, 38 58 L 38 50" stroke="oklch(0.66 0.18 295 / 0.4)" strokeWidth="0.6" fill="none" />
      </motion.g>
      {/* Enrollment pipeline */}
      <motion.path d="M 50 42 L 70 42" stroke="oklch(0.78 0.165 70 / 0.4)" strokeWidth="0.6" strokeDasharray="2 2" variants={draw(1)} />
      {/* Inquiry → Nurture → Enroll */}
      {[
        { x: 70, label: "INQUIRY", color: "oklch(0.7 0.015 260 / 0.5)" },
      ...
      <motion.path d="M 90 42 L 95 42" stroke="oklch(0.78 0.165 70 / 0.35)" strokeWidth="0.5" variants={draw(2)} />
      <motion.path d="M 115 42 L 120 42" stroke="oklch(0.78 0.165 70 / 0.35)" strokeWidth="0.5" variants={draw(3)} />
      {/* Results */}
      <motion.g variants={pop(5)}>
        ...
        <text x="105" y="85" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="5" fill="oklch(0.74 0.16 155 / 0.5)">FASTER ENROLLMENT</text>
      </motion.g>
      <motion.g variants={pop(6)}>
...
export function IllustManufacturing({ className = "" }: { className?: string }) {
  return (
    <motion.svg viewBox="0 0 160 110" fill="none" className={className} initial="hidden" whileInView="visible" viewport={{ once: true }}>
      ...
      <motion.text x="80" y="62" textAnchor="middle" fontFamily="var(--font-mono)" fontSize="5" fill="oklch(0.78 0.165 70 / 0.45)" variants={pop(1)}>ONE DASHBOARD</motion.text>
      {/* Satellite modules */}
      {[
