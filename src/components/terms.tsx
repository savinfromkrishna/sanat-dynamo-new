    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="relative h-[60vh] min-h-[400px] w-full flex items-center justify-center overflow-hidden bg-slate-900">
        ...
        <div className="relative z-10 text-center px-4">
          <p className="text-blue-400 font-bold tracking-[0.3em] uppercase mb-4 text-sm animate-fade-in">
            {terms.lastUpdated}
          </p>
      ...
      <div className="max-w-4xl mx-auto px-6 py-20">
        <div className="mb-20">
          <p className="text-2xl md:text-3xl font-medium text-slate-800 leading-snug border-l-4 border-blue-600 pl-8">
            {terms.introduction}
          </p>
        </div>
        ...
        <div className="space-y-24">
          {terms.sections.map((section: any, index: number) => (
            <section key={index} className="relative">
              <h2 className="text-sm font-black text-blue-600 tracking-widest uppercase mb-8 flex items-center gap-4">
